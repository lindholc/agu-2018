...
\maketitle[titletoblockverticalspace=0em]
  ...
  \begin{columns}
    ...
    \begin{subcolumns}
      ...
      \block{Overview}{
        ...
        \item The LASP HAPI server is a standalone data server
          ...
          Interface (HAPI) 2.0 specification.
        ...
        \item It is open source and developed on GitHub.
        \end{itemize}
      }
    ...
    \block{Server Implementation}{
      ...
      default data access library, any library for which an
      ...
      \begin{minipage}[t]{0.45\linewidth}
        ...
        Each backend provides an interpreter for the algebras defined
        above. The default interpreter uses the LaTiS 2 library.
